...
class NeuroFetalNet_without_pe(nn.Module):
    def __init__(
        self, num_classes: int = 2, in_channels: int = 1, dropout: float = 0.5
    ):
        super(NeuroFetalNet_without_pe, self).__init__()
...
if __name__ == "__main__":
    ...
    print(device)
    model = NeuroFetalNet_without_pe(num_classes=2, in_channels=1).to(device)
