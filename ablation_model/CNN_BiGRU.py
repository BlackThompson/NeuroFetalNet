...
class CRNN(nn.Module):
    def __init__(
        ...
        self.cnn = nn.Sequential(
            ...
            nn.AvgPool1d(2, 2),
            CNNBlock(32, 64, kernel_size=kernel_size, padding=kernel_size // 2),
            nn.AvgPool1d(2, 2),
            CNNBlock(64, 128, kernel_size=kernel_size, padding=kernel_size // 2),
            nn.AvgPool1d(4, 4),
            CNNBlock(128, 128, kernel_size=kernel_size, padding=kernel_size // 2),
            nn.AvgPool1d(4, 4),
            CNNBlock(128, 128, kernel_size=kernel_size, padding=kernel_size // 2),
        )
